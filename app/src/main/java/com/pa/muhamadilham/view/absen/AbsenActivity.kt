package com.pa.muhamadilham.view.absen
...
import com.pa.muhamadilham.BuildConfig
import com.pa.muhamadilham.R
import com.pa.muhamadilham.utils.BitmapManager.bitmapToBase64
import com.pa.muhamadilham.viewmodel.AbsenViewModel
...
class AbsenActivity : AppCompatActivity() {
    ...
    lateinit var progressDialog: ProgressDialog1
    ...
    private fun convertImage(imageFilePath: String?) {
        ...
        if (imageFile.exists()) {
            ...
            if (bitmapImage == null) {
                Toast.makeText(this@AbsenActivity,
                    "foto belum di input!", Toast.LENGTH_LONG).show()
            } else {
